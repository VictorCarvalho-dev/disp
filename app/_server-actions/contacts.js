...
export async function getContacts() {
  ...
  try {
    ...
    const response = await Axios.get("https://sand.libanoinstituto.com.br/listContacts", {
      headers: {
...
export async function getContactsByList(listId) {
    ...
    try {
      const cookieStore = await cookies();
      const userCookie = cookieStore.get("user");
      const response = await Axios.get(`https://sand.libanoinstituto.com.br/contact/${listId}`, {
        headers: {
          "Key": userCookie?.value,
        },
...
export async function createContactList(data, name) {
  ...
  try {
    ...
    const response = await Axios.post(
      `https://sand.libanoinstituto.com.br/uploadContacts/${name}`,
      data,
      {
        headers: {
          "Key": userCookie?.value,
...
export async function deleteContactByIds(ids, listId) {
  ...
  try {
    ...
    const response = await Axios.put(
      `https://sand.libanoinstituto.com.br/deleteContactsByIds/${listId}`,
      {
        idsDelete: ids,
      },
      {
...
export async function deleteContactList(listId) {
  ...
  try {
    ...
    const response = await Axios.delete(
      `https://sand.libanoinstituto.com.br/deleteContact/${listId}`,
      {
        headers: {
          "Key": userCookie?.value,
        },
