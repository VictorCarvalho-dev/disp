...
export async function getChecks() {
  ...
  try {
    ...
    const response = await fetch("https://prod.libanoinstituto.com.br/listContactsCheck", {
      headers: {
...
export async function createCheck(data, name) {
  ...
  try {
    ...
    const response = await Axios.post(
      `https://prod.libanoinstituto.com.br/uploadContactsCheck/${name}`,
      data,
      {
        headers: {
          "Key": userCookie?.value,
...
export async function cancelCheck(checkId) {
  ...
  try {
    ...
    const userCookie = cookieStore.get("user");
    const response = await Axios.post(
      `https://prod.libanoinstituto.com.br/contactsCheck/${checkId}/canceled`,
      {},
      {
        headers: {
          "Key": userCookie?.value,
...
export async function downloadCSV(checkId) {
  ...
  try {
    ...
    const response = await Axios.get(
      `https://prod.libanoinstituto.com.br/downloadCheckCSV/${checkId}`,
      {
        headers: {
          "Key": userCookie?.value,
        },
