...
export async function getActiveConnections() {
  ...
  try {
    ...
    const response = await Axios.get("https://prod.libanoinstituto.com.br/listConnections/active", {
      headers: {
...
export async function postShots(start, end) {
  ...
  try {
    ...
    const response = await Axios.post("https://prod.libanoinstituto.com.br/dashShots", requestBody, {
      headers: {
