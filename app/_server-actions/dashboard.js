...
export async function getActiveConnections() {
  ...
  try {
    ...
    const response = await Axios.get("https://sand.libanoinstituto.com.br/listConnections/active", {
      headers: {
...
export async function postShots(start, end) {
  ...
  try {
    ...
    const response = await Axios.post("https://sand.libanoinstituto.com.br/dashShots", requestBody, {
      headers: {
