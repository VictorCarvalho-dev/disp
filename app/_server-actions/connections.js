...
export async function getConnections() {
    try {
        ...
        const connections = await Axios.get("https://prod.libanoinstituto.com.br/listConnections/all", {
            headers: {
...
export async function getActiveConnections() {
    try {
        ...
        const cookieStore = await cookies();
        const userCookie = cookieStore.get("user");
        const connections = await Axios.get("https://prod.libanoinstituto.com.br/listConnections/active", {
            headers: {
                "Key": userCookie?.value
            },
            next: { tags: ['connections'] }
...
export async function getHeaterConnections() {
    try {
        ...
        const cookieStore = await cookies();
        const userCookie = cookieStore.get("user");
        const connections = await Axios.get("https://prod.libanoinstituto.com.br/listConnections/heater", {
            headers: {
                "Key": userCookie?.value
            },
            next: { tags: ['connections'] }
...
export async function createConnection(values) {
    ...
    try {
        const cookieStore = await cookies();
        const userCookie = cookieStore.get("user");
        const connections = await Axios.post("https://prod.libanoinstituto.com.br/createConnection", {
...
export async function deleteConnection(id) {
    ...
    try {
        const cookieStore = await cookies();
        const userCookie = cookieStore.get("user");
        const connections = await Axios.delete(`https://prod.libanoinstituto.com.br/deleteConnection/${id}`, {
            headers: {
                "Key": userCookie?.value
            }
        });
...
export async function statusConnection(id) {
    ...
    try {
        const cookieStore = await cookies();
        const userCookie = cookieStore.get("user");
        const connections = await Axios.get(`https://prod.libanoinstituto.com.br/checkConnection/${id}`, {
            headers: {
                "Key": userCookie?.value
            }
        });
...
export async function updateConnection(id, data) {
    ...
    try {
        const cookieStore = await cookies();
        const userCookie = cookieStore.get("user");
        const connection = await Axios.put(`https://prod.libanoinstituto.com.br/updateHeater/${id}`, {
            heater: data,
        }, {
            headers: {
                "Key": userCookie?.value
...
export async function generateQrCode(id) {
    ...
    try {
        const cookieStore = await cookies();
        const userCookie = cookieStore.get("user");
        const connections = await Axios.get(`https://prod.libanoinstituto.com.br/qrcodeConnection/${id}`, {
            headers: {
                "Key": userCookie?.value
            }
        });
...
export async function disconnectConnection(id) {
    ...
    try {
        ...
        const response = await Axios.put(
            `https://prod.libanoinstituto.com.br/disconnectConnection/${id}`,
