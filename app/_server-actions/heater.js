...
export async function getHeaters() {
  ...
  try {
    ...
    const response = await Axios.get("https://sand.libanoinstituto.com.br/heaterList", {
      headers: {
...
export async function createHeater(data) {
  ...
  try {
    ...
    const response = await Axios.post(
      "https://sand.libanoinstituto.com.br/heater",
      data,
      {
        headers: {
          "Key": userCookie?.value,
...
export async function cancelHeater(id) {
  ...
  try {
    ...
    const response = await Axios.put(
      `https://sand.libanoinstituto.com.br/heaterCanceled/${id}`,
      {},
      {
        headers: {
          "Key": userCookie?.value,
